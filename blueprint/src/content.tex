...
\begin{definition}[約数関数] \label{Arithmetic_Function}~\
\lean{morishitasigma}
\leanok
...
(4) 乗法的関数 \label{isMultiplicative}\lean{isMultiplicative_sigma}\leanokである。すなわち、互いに素な自然数 \( m, n \) に対して、\( \sigma(mn) = \sigma(m) \cdot \sigma(n) \).
