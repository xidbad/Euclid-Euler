...
\lean{perfect_iff_sum_divisors_eq_two_mul}\leanok\uses{perfect, sigma_one_apply_}
...
\begin{lemma}\label{isMultiplicative}\lean{isMultiplicative_sigma}\leanok\uses{sigma_one_apply_}
