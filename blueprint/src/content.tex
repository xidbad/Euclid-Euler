...
\uses{sigma_two_pow_eq_mersenne_succ}\uses{Mersenne}\uses{prime_iff_sum_divisors_eq_succ}~\
...
\lean{even_two_pow_mul_mersenne_of_prime}\leanok\uses{ne_zero_of_prime_mersenne}\uses{Mersenne}~\
...
\lean{eq_two_pow_mul_prime_mersenne_of_even_perfect}\leanok\uses{eq_two_pow_mul_odd}
\uses{sum_properDivisors_dvd}\uses{perfect}\uses{sigma_two_pow_eq_mersenne_succ}~\
...
\uses{even_two_pow_mul_mersenne_of_prime}\uses{perfect_two_pow_mul_mersenne_of_prime}~\
