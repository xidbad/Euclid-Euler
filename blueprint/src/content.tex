...
\sigma(M_{k+1}j) = 2^{k+1}j ~&\Leftrightarrow~ \sum_{d \mid M_{k+1}j} d = 2^{k+1}j\\
                            ~&\Leftrightarrow~ \sum_{\begin{subarray}{c} d \mid M_{k+1}j\\ d < M_{k+1}j \end{subarray}} d + M_{k+1}j = 2^{k+1}j\\
                            ~&\Leftrightarrow~ \sum_{\begin{subarray}{c} d \mid M_{k+1}j\\ d < M_{k+1}j \end{subarray}} d + M_{k+1}j = (M_{k+1}+1)j\\
                            ~&\Leftrightarrow~ \sum_{\begin{subarray}{c} d \mid M_{k+1}j\\ d < M_{k+1}j \end{subarray}} d + M_{k+1}j = M_{k+1}j + j\\
                            ~&\Leftrightarrow~ \sum_{\begin{subarray}{c} d \mid M_{k+1}j\\ d < M_{k+1}j \end{subarray}} d = j
\end{align*}
...
\(j = 1\) のとき,
\[
\sum_{\begin{subarray}{c} d \mid M_{k+1}\\ d < M_{k+1} \end{subarray}} d = 1 \Leftrightarrow M_{k+1} : Prime~~(\because~Lemma6)
\]
